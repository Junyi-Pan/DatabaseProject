...
if(isset($_POST["email"])){
    ...
    try {
        ...
        $mail->Username = 'orangerotteninc@gmail.com';                     //SMTP username
        $mail->Password = 'Database12*';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;            //Enable implicit TLS encryption
        $mail->Port = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('orangerotteninc@gmail.com', 'Rotten Orange Inc');
        $mail->addAddress($emailTo);
        $mail->addReplyTo('orangerotteninc@gmail.com', 'Rotten Orange Inc');
